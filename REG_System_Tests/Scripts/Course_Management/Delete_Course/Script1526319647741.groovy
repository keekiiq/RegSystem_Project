...
WebUI.setText(findTestObject('Page_ (5)/input_UserName'), 'admin')

WebUI.setText(findTestObject('Page_ (5)/input_Password'), 'secret')

WebUI.click(findTestObject('Page_ (5)/input_btn btn-primary'))
...
WebUI.verifyTextPresent('was deleted', false)
