...
WebUI.setText(findTestObject('Page_ (3)/input_Password'), 'secret')

WebUI.click(findTestObject('Page_ (3)/input_btn btn-primary'))

WebUI.click(findTestObject('Edit'))

WebUI.setText(findTestObject('Page_ (2)/input_Name'), courseName)

WebUI.setText(findTestObject('Page_ (1)/textarea_Description'), 'Test')

WebUI.setText(findTestObject('Page_ (4)/input_Section'), '701')

WebUI.setText(findTestObject('Page_ (4)/input_Credit'), '3')

WebUI.setText(findTestObject('Page_ (4)/input_Time'), '12.00')

WebUI.setText(findTestObject('Page_ (4)/input_Day'), 'Tue')

WebUI.click(findTestObject('Page_ (2)/input_btn btn-primary'))
