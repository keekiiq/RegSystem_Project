...
WebUI.setText(findTestObject('Page_ (1)/input_Name'), '')

WebUI.setText(findTestObject('Page_ (1)/textarea_Description'), '')

WebUI.setText(findTestObject('Page_ (1)/input_Section'), '')

WebUI.setText(findTestObject('Page_ (1)/input_Credit'), '')

WebUI.setText(findTestObject('Page_ (1)/input_Time'), '')

WebUI.setText(findTestObject('Page_ (1)/input_Day'), '')
